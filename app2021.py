...
def main():
	...
	st.title("Predicción Peso Colmena Artificial de abejas Apis Melífera.")
	menu =["Inicio"]
	...
	if choice == "Inicio":
		...
		if data_file is not None:
			...
			st.write(d_r)
			#st.subheader('Por lo que el número de días máximo en el pasado sería inferior o igual a: ')
			#st.write(val_max)
